...
IUSE="
	alsa chromium doc +encode oss pic sndio static-libs test v4l decklink
	${FFMPEG_FLAG_MAP[@]%:*}
	${FFMPEG_ENCODER_FLAG_MAP[@]%:*}
"
...
RDEPEND="
	...
	decklink? ( >=media-video/decklink-drivers-12.5 )
"
...
multilib_src_configure() {
	...
	use decklink && myconf+=( --enable-decklink ) && myconf+=( --enable-nonfree )
        use cuda && myconf+=( --enable-cuda-nvcc ) && myconf+=( --enable-libnpp )
